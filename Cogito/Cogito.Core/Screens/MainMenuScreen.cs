...
internal class MainMenuScreen : MenuScreen
{
    ...
    private readonly MenuEntry tutorialMenuEntry;
    ...
    private void SetLanguageText()
    {
        ...
        Title = "Cogito"; // TODO uncomment this if you want it to use Resources.MainMenu; instead
    }
    ...
    public override void LoadContent()
    {
        ...
        // Load the level.
        var levelPath = "Content/Levels/00.txt";
    ...
    private void DrawTutorialSteps(SpriteBatch spriteBatch)
    {
        ...
        var backgroundRectangle = Rectangle.Empty;
        Vector2 textSize;
        ...
        switch (tutorialStep)
        {
            ...
            case 1:
                ...
                textSize = font.MeasureString(message);
                backgroundRectangle = new Rectangle(level.Exit.X - 50 - hPad,
                    level.Exit.Y - vPad - 60,
                    (int)textSize.X + hPad * 2,
                    (int)textSize.Y + vPad * 2);
                break;
        ...
        var textPosition = new Vector2(backgroundRectangle.X + hPad, backgroundRectangle.Y + vPad);
    ...
    {
        var message = Resources.ExitQuestion;
