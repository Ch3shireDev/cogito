...
internal class GameplayScreen : GameScreen
{
    ...
    /// </summary>
    private SettingsManager<CogitoLeaderboard> leaderboardManager;
    ...
    public override void LoadContent()
    {
        ...
        leaderboardManager ??= ScreenManager.Game.Services.GetService<SettingsManager<CogitoLeaderboard>>();
    ...
    public override void HandleInput(GameTime gameTime, InputState inputState)
    {
        ...
        var playerIndex = ControllingPlayer != null ? (int)ControllingPlayer.Value : (int)PlayerIndex.One;

        // The game pauses either if the user presses the pause button, or if
        // they unplug the active gamepad. This requires us to keep track of
        // whether a gamepad was ever plugged in, because we don't want to pause
        // on PC if they are playing with a keyboard and have no gamepad at all!
        var gamePadDisconnected = !currentGamePadState.IsConnected && previousGamePadState.IsConnected;
